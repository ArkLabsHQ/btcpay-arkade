...
//     }
//
//     public Task<Dictionary<string, ISigningEntity>> CreateSigners(string[] effectiveWalletIds, CancellationToken cancellationToken)
//     {
//         return Task.FromResult(_walletSigners.Where(x => effectiveWalletIds.Contains(x.Key)).ToDictionary(x => x.Key, x => x.Value));
//     }
//
//     #endregion
//
