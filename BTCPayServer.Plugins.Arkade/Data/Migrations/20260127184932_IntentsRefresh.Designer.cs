...
namespace BTCPayServer.Plugins.Arkade.Data.Migrations
{
    ...
    [Migration("20260127184932_IntentsRefresh")]
    partial class IntentsRefresh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.Arkade.Data.ArkIntent", b =>
                {
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.Arkade.Data.ArkIntentVtxo", b =>
                {
                    b.Property<string>("IntentTxId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.Arkade.Data.Entities.ArkSwap", b =>
                {
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.Arkade.Data.Entities.ArkWallet", b =>
                {
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.Arkade.Data.Entities.ArkWalletContract", b =>
                {
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.Arkade.Data.Entities.VTXO", b =>
                {
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.Arkade.Data.ArkIntentVtxo", b =>
                {
                    b.HasOne("BTCPayServer.Plugins.Arkade.Data.ArkIntent", "Intent")
                        .WithMany("IntentVtxos")
                        .HasForeignKey("IntentTxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BTCPayServer.Plugins.Arkade.Data.Entities.VTXO", "Vtxo")
                        .WithMany("IntentVtxos")
            ...
            modelBuilder.Entity("BTCPayServer.Plugins.Arkade.Data.Entities.ArkSwap", b =>
                {
                    b.HasOne("BTCPayServer.Plugins.Arkade.Data.Entities.ArkWallet", "Wallet")
                        .WithMany("Swaps")
                        .HasForeignKey("WalletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BTCPayServer.Plugins.Arkade.Data.Entities.ArkWalletContract", "Contract")
                        .WithMany("Swaps")
