...
using NBitcoin;
using ArkIntent = BTCPayServer.Plugins.Arkade.Data.ArkIntent;
using PluginArkIntent = BTCPayServer.Plugins.Arkade.Data.ArkIntent;
...
public class EfCoreIntentStorage : IIntentStorage
{
    ...
    private NNarkArkIntent MapToNNarkIntent(ArkIntent entity)
    {
    ...
    /// </summary>
    public async Task<IReadOnlyList<ArkIntent>> GetIntentsWithPaginationAsync(
        string walletId,
        int skip = 0,
        int count = 10,
