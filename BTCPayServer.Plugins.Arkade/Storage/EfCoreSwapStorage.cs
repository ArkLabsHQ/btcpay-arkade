...
using ArkSwap = BTCPayServer.Plugins.Arkade.Data.Entities.ArkSwap;
using Entities_ArkSwap = BTCPayServer.Plugins.Arkade.Data.Entities.ArkSwap;
...
public class EfCoreSwapStorage : ISwapStorage
{
    ...
    public async Task SaveSwap(string walletId, NNarkArkSwap swap, CancellationToken cancellationToken = default)
    {
        ...
        {
            var entity = new Entities_ArkSwap
            {
                SwapId = swap.SwapId,
                WalletId = walletId,
    ...
    private static NNarkArkSwap MapToNNarkSwap(Entities_ArkSwap entity)
    {
